...
type UserModel struct {
	...
	// @gotags: json:"id"
	UserId uint32 `protobuf:"varint,1,opt,name=UserId,proto3" json:"id"`
	// @gotags: json:"name"
	UserName string `protobuf:"bytes,2,opt,name=UserName,proto3" json:"name"`
	// @gotags: json:"nick_name"
	NickName string `protobuf:"bytes,3,opt,name=NickName,proto3" json:"nick_name"`
}
